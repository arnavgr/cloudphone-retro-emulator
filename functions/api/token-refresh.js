// ── Cloudflare Worker: token-refresh ─────────────────────────────────────────
// Deploy to Cloudflare Workers. Set these secrets via wrangler or the dashboard:
...
//   3. wrangler deploy
//
// Then set WORKER_URL in auth.js to your deployed worker URL.
// ─────────────────────────────────────────────────────────────────────────────
...
function corsHeaders(request) {
  ...
  // In production you can lock this to your exact origin instead.
